...
// ✅ ฟังก์ชัน deactivate user
async function deactivateUser(id: number) {
  try {
    const res = await axios.put(`http://localhost:8080/api/users/hide/${id}`);
...
// ✅ computed แยก active / inactive users
      ...
      <div class="mb-4 flex items-center justify-between gap-3 flex-nowrap">
        ...
        <div class="flex items-center gap-3 flex-nowrap">
          <router-link
            ...
            class="inline-flex items-center justify-center gap-2 h-[40px] px-4 bg-yellow-500 text-black rounded-md hover:bg-yellow-600 transition whitespace-nowrap"
          >
          ...
          <table class="min-w-full text-gray-700 border-collapse">
            <thead class="bg-gray-100 text-[16px] font-semibold">
              <tr>
                ...
                <th class="px-6 py-3 text-left pl-[80px]">Name</th>
                <th class="px-6 py-3 text-left pl-[80px]">Email</th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-3 text-left font-medium text-blue-600">
