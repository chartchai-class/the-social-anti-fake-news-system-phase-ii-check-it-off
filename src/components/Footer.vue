<template>
  <footer
    class="ml-[50px] w-[calc(120%-50px)] bg-gradient-to-tr from-blue-500/70 via-blue-500/50 via-green-500/70 to-green-300/70 px-8 py-7 rounded-[15px] text-white font-[Outfit] shadow-[0_-2px_10px_rgba(0,0,0,0.15)] mt-3 text-center"
  >
